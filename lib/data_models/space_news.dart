...
List<SpaceNews> spaceNewsFromJson(String str) => List<SpaceNews>.from(json.decode(str).map((x) => SpaceNews.fromJson(x)));

String spaceNewsToJson(List<SpaceNews> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
